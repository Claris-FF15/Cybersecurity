...
* ls in every folders to find the one
* the answer is folder4

What is the contents of this file?

* command to do is cat note.txt
* the answer is Hello World!

Use the cd command to navigate to this file and find out the new current working directory. What is the path?

* pwd
* the answer is /home/tryhackme/folder4
...
* use grep -R "THM" /home/tryhackme/
* the answer is THM{ACCESS}
